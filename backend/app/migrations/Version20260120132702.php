 ...
 */
final class Version20260120132702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ability (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, characteristic_id INT NOT NULL, INDEX IDX_35CFEE3CDEE9D12B (characteristic_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE characteristic (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, score INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE characteristic_character (characteristic_id INT NOT NULL, character_id INT NOT NULL, INDEX IDX_BBE92BB2DEE9D12B (characteristic_id), INDEX IDX_BBE92BB21136BE75 (character_id), PRIMARY KEY (characteristic_id, character_id)) DEFAULT CHARACTER SET utf8mb4');
